...
void main()
{
printf("\n\tEnter Any Integer Expression which can have operations Addition,Subtraction, Multiplication, Division,Modulus and Round brackets:\n");

yyparse();
if(flag==0)
printf("\n\t\tEntered Integer expression is Valid\n\n");
}

void yyerror()
{
printf("\n\t\tEntered Integer expression is Invalid!!\n\n");
flag=1;
}
